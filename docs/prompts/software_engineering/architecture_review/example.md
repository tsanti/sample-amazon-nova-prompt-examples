...
!!! success "Response"
    --8<-- "results/software_engineering_architecture_review_20251201_131057.md"

### API Request
=== "python"

    ```python
    --8<-- "docs/prompts/software_engineering/architecture_review/example.py"
    ```

=== "AWS CLI"

    ```bash
    --8<-- "docs/prompts/software_engineering/architecture_review/example.sh"
    ```

=== "json"

    ```json
    --8<-- "docs/prompts/software_engineering/architecture_review/example.json"
    ```
