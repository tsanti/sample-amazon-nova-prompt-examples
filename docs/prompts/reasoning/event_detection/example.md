...
!!! success "Response"
    --8<-- "results/event_detection_20251122_144501.md"

### API Request
=== "python"

      ```python
      --8<-- "docs/prompts/reasoning/event_detection/example.py"
      ```

=== "AWS CLI"

      ```bash
      --8<-- "docs/prompts/reasoning/event_detection/example.sh"
      ```

=== "json"

      ```json
      --8<-- "docs/prompts/reasoning/event_detection/example.json"
      ```
